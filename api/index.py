...
def index2():
    if 'username' in session:
        update_user_data()
        return render_template('base.html', username=session['username'], online_users=online_users, offline_users=offline_users, user_counts=user_counts, timestamps=timestamps)
